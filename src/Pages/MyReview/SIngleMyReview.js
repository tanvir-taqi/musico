...
const SIngleMyReview = ({ myreviewSingle, handleDelete ,handleUpdateModal}) => {

    const { customer,  photo,  message, serviceName, _id } = myreviewSingle
    return (
        <div>
            
            <div className='color-bg md:mx-12 my-12 p-10 rounded'>
                ...
                <button  onClick={()=> handleUpdateModal(_id)} className='mb-5 mt-16 w-52 flex items-center justify-center py-1 rounded-full rounded-br-lg font-semibold bg-rose-400'><span className='mx-2'>Edit Review</span> <FaEdit></FaEdit> </button>
